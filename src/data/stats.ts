...
export const stats: StatItem[] = [
  ...
  { label: 'Socios activos', target: 12500, prefix: '+' },
  // Reemplazar por los años reales de operación.
  { label: 'Años de experiencia', target: 25 },
  // Reemplazar por la cantidad real de sucursales.
  { label: 'Sucursales', target: 14 },
  // Reemplazar por el monto real en activos gestionados.
  { label: 'En activos gestionados', target: 1.8, prefix: 'RD$', suffix: 'B', decimals: 1 },
];
